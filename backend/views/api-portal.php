  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; }
    body {
      ...
      background:
        radial-gradient(900px 500px at 10% -10%, rgb(0 229 255 / 0.12), transparent 55%),
        radial-gradient(700px 400px at 100% 0%, rgb(139 92 255 / 0.14), transparent 50%),
        var(--void);
      color: var(--mist);
      min-height: 100vh;
      line-height: 1.5;
    ...
    .grid-bg {
      ...
      background-image: linear-gradient(rgb(0 229 255 / 0.06) 1px, transparent 1px),
        linear-gradient(90deg, rgb(0 229 255 / 0.06) 1px, transparent 1px);
      background-size: 48px 48px;
    }
    .wrap { position: relative; max-width: 1080px; margin: 0 auto; padding: 2rem 1.25rem 4rem; }
    .ribbon { display: flex; height: 4px; margin-bottom: 1.5rem; border-radius: 2px; overflow: hidden; }
    .ribbon span { flex: 1; }
    ...
    .logo-icon {
      ...
      background: var(--cyan); color: var(--ink); border: 2.5px solid var(--ink);
    ...
    .sub { color: var(--fog); font-size: 0.95rem; max-width: 36rem; margin-top: 0.5rem; }
    .status-pill {
    ...
    .dot { width: 8px; height: 8px; border-radius: 50%; background: var(--fog); animation: pulse 2s infinite; }
    ...
    .card {
      background: var(--panel); border: 2.5px solid rgb(0 229 255 / 0.35);
      border-radius: 14px; padding: 1rem 1.1rem;
      box-shadow: 5px 5px 0 rgb(139 92 255 / 0.55);
    }
    .card-label {
    ...
    .btn-primary { background: var(--cyan); box-shadow: 4px 4px 0 var(--magenta); }
    .btn-ghost { background: var(--panel); color: var(--mist); box-shadow: 4px 4px 0 var(--violet); }
    .section-title {
    ...
    .endpoint {
      ...
      background: var(--field); border: 2px solid rgb(255 255 255 / 0.06);
      border-radius: 12px; transition: border-color 0.2s;
    }
    .endpoint:hover { border-color: rgb(0 229 255 / 0.45); }
    .method {
    ...
    .method-get { background: var(--emerald); color: var(--ink); }
    .method-post { background: var(--amber); color: var(--ink); }
    .path { font-family: ui-monospace, monospace; font-size: 0.88rem; color: var(--cyan); }
    .desc { font-size: 0.85rem; color: var(--fog); margin-top: 0.25rem; grid-column: 2; }
    .badges { display: flex; flex-wrap: wrap; gap: 0.35rem; margin-top: 0.4rem; grid-column: 2; }
    .badge {
      font-size: 0.62rem; letter-spacing: 0.08em; text-transform: uppercase;
      padding: 0.15rem 0.45rem; border-radius: 4px;
      border: 1px solid rgb(255 255 255 / 0.12); color: var(--fog);
    }
    .badge-jwt { border-color: var(--violet); color: var(--violet); }
    .try-link {
    ...
    .try-link:hover { background: rgb(0 229 255 / 0.12); }
    .curl-box {
      margin-top: 2rem; padding: 1.25rem; background: #161221; border: 2.5px solid var(--ink);
      border-radius: 14px; box-shadow: 5px 5px 0 var(--cyan);
    }
    .curl-box pre {
      font-family: ui-monospace, monospace; font-size: 0.78rem; line-height: 1.6;
      color: #9ae6ff; overflow-x: auto; white-space: pre-wrap; word-break: break-all;
    }
    footer {
      margin-top: 3rem; padding-top: 1.5rem; border-top: 1px solid rgb(255 255 255 / 0.08);
      font-size: 0.8rem; color: var(--fog); text-align: center;
    }
