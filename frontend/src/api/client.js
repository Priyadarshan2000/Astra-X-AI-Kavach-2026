...
export const api = {
  ...
  patch: (payload, token) => request('/patch.php', { method: 'POST', body: payload, token, timeoutMs: 25000 }),
  explainPatch: (payload) => request('/explain.php', { method: 'POST', body: payload, timeoutMs: 25000 }),
